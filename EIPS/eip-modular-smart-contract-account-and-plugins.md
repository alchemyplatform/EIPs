...
Account interface. Modular Smart Contract Accounts MUST emit `Executed` for every execution function executed. It MAY implement `viewCall` to support view functions without the need to add view functions selectors into storage through updatePlugins.
...
>   event Executed(
>        bytes4 _executePlugin,
>        bytes4 _uoValidator,
>        bytes4 _rtValidator,
>        bytes4 _preHook,
>        bytes4 _postHook,
>        bytes4 _globalPreHooks,
>        bytes4 _globalPostHooks
>    );
>
>    /**
